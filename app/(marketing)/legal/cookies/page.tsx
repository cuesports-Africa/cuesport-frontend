...
export default function CookiePolicyPage() {
  return (
    <LegalArticle
      ...
      title="The crumbs we keep."
      lead="A short note on the small files we use to keep you logged in, remember your preferences, and understand how the platform is used."
      lastUpdated="January 2026"
      contactEmail="privacy@cuesportsafrica.com"
      current="cookies"
    >
      <section>
        <h2>Cookies</h2>
      ...
      <section>
        <h2>How CueSports Africa uses cookies</h2>
        <p>We use cookies on our platform for several purposes:</p>
        <p><strong>Essential cookies:</strong> These are necessary for the website to function. They enable core features like user authentication, session management, and security. Without these cookies, services you have requested cannot be provided.</p>
        <p><strong>Preference cookies:</strong> These remember choices you make, such as your language setting, display preferences, or whether you have dismissed a notification. They help provide a more personalised experience.</p>
        <p><strong>Session cookies:</strong> These keep you logged in as you navigate between pages. They are temporary and are deleted when you close your browser.</p>
      ...
      <section>
        ...
        <p>You have control over the cookies stored on your device. Most web browsers allow you to:</p>
        <ul>
        ...
        <p>Each browser handles cookie settings differently. Check your browser&rsquo;s help section for instructions on how to manage cookies.</p>
