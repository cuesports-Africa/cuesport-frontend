...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  // Static pages — only URLs that resolve. Audit before adding.
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/players`, lastModified: new Date(), changeFrequency: "daily", priority: 0.8 },
    { url: `${BASE_URL}/news`, lastModified: new Date(), changeFrequency: "daily", priority: 0.8 },
    { url: `${BASE_URL}/rules`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${BASE_URL}/about/contact`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.5 },

    // Utility
    { url: `${BASE_URL}/availability`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.4 },
